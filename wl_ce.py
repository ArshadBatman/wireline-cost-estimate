...
if uploaded_file:
    ...
    for tab, hole_size in zip(tabs, hole_sizes):
        with tab:
            ...
            special_cases_map = {"STANDARD WELLS": {}, "HT WELLS": {}}
            ...
            df_tools["Reference Well"] = "Well A"  # ✅ Added Reference Well
            ...
            if not df_tools.empty:
                ...
                calc_df["Reference Well"] = df_tools["Reference Well"]  # ✅ Include in calculations
...
# Excel download code remains unchanged; include Reference Well column in export
